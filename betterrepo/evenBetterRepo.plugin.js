...
evenBetterRepo.prototype.getDescription = function(){
    return 'Easily access theme & plugin repository from within Hummus client<br><br>Want to add your plugin or theme?  DM natsu#1863 on Hummus.';
};
...
evenBetterRepo.prototype.load = function(){
    if (process.platform == "win32") {
        this.themePath = process.env.APPDATA + "\\BetterHummus\\themes\\";
        this.pluginPath = process.env.APPDATA + "\\BetterHummus\\plugins\\";
    } else if (process.platform == "linux"){
        this.themePath= process.env.HOME + "/.config/BetterHummus/themes/";
        this.pluginPath= process.env.HOME + "/.config/BetterHummus/plugins/";
    } else if (process.platform == "darwin"){
        this.themePath = process.env.HOME + "/Library/Preferences/BetterHummus/themes/";
        this.pluginPath = process.env.HOME + "/Library/Preferences/BetterHummus/plugins/";
    }
